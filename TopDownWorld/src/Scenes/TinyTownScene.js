class TinyTown extends Phaser.Scene {
    ...
    create() {
        ...
        document.getElementById('description').innerHTML = '<h2>Welcome to Singleton Town</h2>'
        ...
        this.honeyLayer = this.map.createLayer("Honey-n-Ground", this.tileset, 0, 0);

        this.grassLayer.setScale(4.0);
        this.treeLayer.setScale(4.0);
        this.honeyLayer.setScale(4.0);
    }
